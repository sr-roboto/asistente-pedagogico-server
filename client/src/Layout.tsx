...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/ai-chat', label: 'Tomi Chatbot', icon: MessageSquare },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-green-200">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-green-200/40 rounded-full blur-[100px]" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-blue-200/40 rounded-full blur-[100px]" />
      </div>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-slate-200 overflow-hidden bg-white/95 backdrop-blur-xl"
            >
